...
class TestWindowManager(TestCase):
    ...
    def test_obtain_tabs_when_no_repeated_links(self, mock_window, mock_copy_paste_link):
    ...
    # def test_obtain_tabs_when_repeated_links_first_last(self):
    #
    #     testCapturedTabs = ["https://saulfernandezgarcia.github.io",
    #                         "https://www.google.com",
    #                         "https://www.youtube.com",
    #                         "https://saulfernandezgarcia.github.io"]
    #
    ...
    #
    # def test_obtain_tabs_when_repeated_links_first_middle(self):
    #
    #     testCapturedTabs = ["https://saulfernandezgarcia.github.io",
    #                         "https://www.google.com",
    #                         "https://www.youtube.com",
